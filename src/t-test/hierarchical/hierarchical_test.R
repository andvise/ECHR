  ...
  
{
  ...
  if (samplingType=="student") {
    stanfit <-  stan(file = '/home/andrea/Downloads/tutorial-master/hierarchical/stan/hierarchical-t-test.stan', data = dataList,sample_file=sample_file, chains=chains)
  }
  ...
  #this Gamma is however very close to  it.
    ...
    stanfit <-  stan(file = '/home/andrea/Downloads/tutorial-master/hierarchical/stan/hierarchical-t-test_nuKru.stan', data = dataList,sample_file=sample_file, chains=chains)
  }
  #this calls the Student with priors Ga (2,0.1) on the dof as in Juanez and Steel
  else if (samplingType=="studentJuanez") {
    stanfit <-  stan(file = '/home/andrea/Downloads/tutorial-master/hierarchical/stan/hierarchical-t-test_nuJuaSteel.stan', data = dataList,sample_file=sample_file, chains=chains)
  }
  
  #this calls the Gaussian
  else if (samplingType=="gaussian") {
    stanfit <-  stan(file = '/home/andrea/Downloads/tutorial-master/hierarchical/stan/hierarchical-t-testGaussian.stan', data = dataList,sample_file=sample_file, chains=chains)
  }
